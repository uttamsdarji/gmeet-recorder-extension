!(function (e, t) {
  ...
  q.inherits(ye, M, { __CANCEL__: !0 });
  var ve = re.isStandardBrowserEnv
    ? {
  ...
  var Oe = function (e) {
    for (var t, n, r = (e = q.isArray(e) ? e : [e]).length, o = 0; o < r && ((t = e[o]), !(n = q.isString(t) ? Ee[t.toLowerCase()] : t)); o++);
    if (!n) {
      if (!1 === n) throw new M("Adapter ".concat(t, " is not supported by the environment"), "ERR_NOT_SUPPORT");
      throw new Error(q.hasOwnProp(Ee, t) ? "Adapter '".concat(t, "' is not available in the build") : "Unknown adapter '".concat(t, "'"));
    }
        ...
        r(e, [
          {
            ...
            value: function (e, t) {
              ...
              var n = (t = Te(this.defaults, t)),
                ...
                i = n.headers;
              void 0 !== r && xe.assertOptions(r, { silentJSONParsing: Pe.transitional(Pe.boolean), forcedJSONParsing: Pe.transitional(Pe.boolean), clarifyTimeoutError: Pe.transitional(Pe.boolean) }, !1), null != o && (q.isFunction(o) ? (t.paramsSerializer = { serialize: o }) : xe.assertOptions(o, { encode: Pe.function, serialize: Pe.function }, !0)), (t.method = (t.method || this.defaults.method || "get").toLowerCase());
          ...
          },
          {
            key: "getUri",
            value: function (e) {
              return Y(be((e = Te(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
            },
          },
        ]),
        e
    ...
    q.forEach(["post", "put", "patch"], function (e) {
      function t(t) {
        return function (n, r, o) {
          return this.request(Te(o || {}, { method: e, headers: t ? { "Content-Type": "multipart/form-data" } : {}, url: n, data: r }));
        };
      }
  ...
  var Le = (function e(t) {
    ...
    return (
      q.extend(r, Ue.prototype, n, { allOwnKeys: !0 }),
